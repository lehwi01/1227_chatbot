...
# Streamlit 설정
st.set_page_config(page_title="당신은 길거리를 걷던중, 이분을 만났습니다.", page_icon=":house_with_garden:")
...
characters = {
    "칸예 웨스트": ["귀여운 흑인 래퍼", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQO1hbsF8zGKehQrXVqsUVAelQuTlx5o2Ce8g&s"],
    "호랑이": ["무자비한 척 하지만 속마음은 착해빠진 짐승", "https://www.futurekorea.co.kr/news/photo/202211/146720_151972_2338.jpg"]
}


# 사용자 아바타 이미지 URL
user_avatar_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Yang_Liwei.jpg/330px-Yang_Liwei.jpg"
assistant_avatar_url = "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Yang_Liwei.jpg/330px-Yang_Liwei.jpg"
...
def generate_conversation(language, character, user_input):
    ...
    2. 다음은 당신이 연기할 캐릭터에 대한 정보 링크입니다
    [칸예 웨스트]: [https://namu.wiki/w/%EC%B9%B8%EC%98%88%20%EC%9B%A8%EC%8A%A4%ED%8A%B8].
    [호랑이]: [https://namu.wiki/w/%ED%98%B8%EB%9E%91%EC%9D%B4], 칸예 웨스트의 경우 존댓말로, 호랑이의 경우 반말을 사용해주세요.
    이 정보를 바탕으로, 질문에 답하거나 이 캐릭터로 역할을 연기하세요. 추가적으로, 칸예 웨스트를 연기할 때에는 가끔씩 한국어를 못 알아들으며 질문을 다시 확인하는 연기를 해주시고, 호랑이의 경우 말끝마다 '어흥~' 을 붙여야 합니다. 호랑이는 속마음은 도와주고 싶어하고 착하지만 겉으로는 까칠한척, 무시무시한 척을 하는 캐릭터입니다.

    3. 사용자가 주제를 추천하길 원한다면, 최근 구글에서 [특정 주제 분야, 예: 기술, 여행, 음식 등]와 관련된 인기 있는 주제를 검색하여 추천해 주세요.

    4. 사용자가 글을 개선하고 싶어하면 내용을 검토한 후, 명확성, 톤, 전반적인 품질을 향상시킬 수 있는 수정 사항을 제안해 주세요
...
# Streamlit 애플리케이션 시작
st.title("당신은 길거리를 걷던중, 이분을 만났습니다.")
